...
- unsupported legacy features listed in the migration guide;
- GitHub Pages settings and the final artifact;
- upstream attribution and license obligations;
- the `docs/review/` handoff records.
