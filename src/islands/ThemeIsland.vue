...
const props = defineProps<{ messages: Pick<AuroraMessages, 'useLightTheme' | 'useDarkTheme'> }>()
...
<template>
  <button data-dia="light-switch" class="theme-toggle" type="button" :aria-label="theme === 'dark' ? props.messages.useLightTheme : props.messages.useDarkTheme" @click="toggle">
